          ...
          <div className="w-full h-full grid grid-cols-2 relative shadow-lg shadow-[#aba9da]">
            ...
            <div className="w-full h-full">
              {show.map((item,index) => {
                return (
                  <>
                    <div key={index} className="border-4 border-black w-[250px] mx-[300px] my-[70px] p-1">
                      <img
                    ...
                    <p className="absolute top-[40%] text-xl right-[400px] fonn font-bold">
                      {item?.match_info?.match_summary?.second_team_score}
                    </p>
                    <p className="text-sm absolute top-[48%] right-[400px] ">
